...
interface CustomIterator<T> {
  ...
  // Rewind the CustomIterator to the first element.
  rewind(): void;
}
...
/**
 * The client code may or may not know about the Concrete CustomIterator or Collection
